<template>
  <observable v-slot="slotted">
    <Section showDetail="left" :visible="slotted.visible">
      <template v-slot:header><span>Work</span></template>
      <div class="content space-y-2">
        <p class="mt-4">
          <span class="font-semibold">Product Lead</span> at
          <a href="https://www.prezzybox.com" class="link" target="_new"
            >Prezzybox.com</a
          >
        </p>
        <p>
          Status: Working with an amazing group of talented people to create
          moments of happiness by delivering the extraordinary.
        </p>
        <p>
          As a software engineer, this means providing the highest-quality
          shopping experience possible for our customers.
        </p>
        <p>
          As product lead, I'm always on the look out both for areas we need to
          improve upon, as well as new features that will make Prezzybox.com a
          destination renowned for its amazing online experience.
        </p>
      </div>
    </Section>
  </observable>
  ...
  <Observable v-slot="slotted">
    <div
      class="w-full max-w-full h-32 flex flex-row justify-around items-center"
    ...
    >
      <div class="flex flex-col justify-center items-center h-full">
        <svg
          ...
          style="enable-background: new 0 0 3000 1000"
          xml:space="preserve"
          class="dark:text-white md:h-full h-12"
          fill="currentColor"
        >
          <g>
            <g>
              <path
                class="st0"
                d="M260,356c25,0,52.7,3.5,75.6,23.7c24.6,21.6,28.1,50.1,28.1,70c0,36.3-13.8,56.6-24.6,67.8
			...
			c0-12.1-4.3-22-10.8-28.1c-9.9-9.5-24.2-10.8-37.1-10.8H225V488.6z"
              ...
              <path
                class="st0"
                d="M541.3,356c36.7,0,59.6,12.1,73.4,25c12.1,11.7,25,32.4,25,64.3c0,18.1-3.9,40.6-22.5,58.7
			...
			c4.7-4.7,10.8-13.8,10.8-28.1c0-16.4-7.8-25-13.4-29.4c-10.8-8.2-28.1-9.1-36.7-9.1h-15.5V486.8z"
              ...
              <path
                class="st0"
                d="M900.4,412.1h-96.3v55.7h91.5V524h-91.5v63.9h96.3V644H737.6V356h162.8V412.1z"
              />
              <path
                class="st0"
                d="M1079.2,587.9h123.5V644H970l138.2-231.9H992.4V356H1217L1079.2,587.9z"
              />
              <path
                class="st0"
                d="M1382.2,587.9h123.5V644h-232.8l138.2-231.9h-115.7V356h224.5L1382.2,587.9z"
              />
              <path
                class="st0"
                d="M1682.8,509.7L1579.6,356h78.6l57.9,89.4L1774,356h78.6l-103.2,153.7V644h-66.5V509.7z"
              />
              <path
                class="st0"
                d="M2010.2,356c15.5,0,51,0.9,73.4,22c18.6,17.7,20.7,41.9,20.7,54.4c0,11.2-1.7,24.2-9.5,36.7
			...
			c0-11.7-4.7-19.4-9.1-23.3c-11.7-10.8-34.1-10.8-47.5-10.8h-18.1V592.2z"
              ...
              <path
                class="st0"
                d="M2466.5,391.4c27.2,26.3,44.9,64.3,44.9,108.8c0,38.4-13.8,77.7-44.9,108c-26.8,25.9-63,42.3-111.4,42.3
			...
			c-14.3-13.8-37.1-24.6-63.5-24.6C2329.6,410.8,2307.2,419.9,2291.6,435.4z"
              ...
              <path
                class="st0"
                d="M2659.7,491.1L2570.3,356h79.9l47.5,82l47.5-82h79.9l-89.4,135.2L2841.5,644h-79.9l-63.9-99.8l-63.9,99.8
        ...
        <h1 class="text-slate-800 dark:text-white md:text-xl text-lg">
          Product Lead
        </h1>
      </div>
