        ...
        <div class="">
            ...
            <div class="screaming-frog flex flex-row flex-wrap items-center justify-around mt-12" >
                <div class="md:w-2/3 sm:w-full w-full space-y-3 mb-3 md:pr-12">
                    ...
                    <p>I used Docker to build a container which... well, contained, an application to run a Screaming Frog crawl against prezzybox.com every day.</p> 
                    <p>The application would then upload the resulting reports to S3.</p> 
                ...
                <img class="cursor-pointer" src="@/assets/Screaming_Frog_Audits.png" alt="An Example output of the Screaming Frog Runner"  @click="openLightBox('/assets/Screaming_Frog_Audits.png')"/>
